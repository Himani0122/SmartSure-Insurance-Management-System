    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/auth/send-otp")).permitAll()
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/auth/forgot-password")).permitAll()
                        ...
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/auth/send-notification")).permitAll()
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/auth/internal/**")).permitAll()
